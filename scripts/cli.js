...
const contractABI = require("../artifacts/contracts/Smartledger.sol/Smartledger.json").abi;

program
    .name("smartledger-cli")
    .description("CLI tool for Smartledger smart contract")
    .version("1.0.0");
